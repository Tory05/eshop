...
$prod = $database->executeDBQuery($sql);
if (
    isset($_POST["name"]) &&
    isset($_POST["price"]) &&
      ...
      <div class="card-body">
        ...
        <form method="POST" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <input type="name" id="name" class="form-control" name="name" value="<?= $prod[0]['name'] ?>">
          </div>
          <div class="mb-3">
            <label for="price" class="form-label">Alapár</label>
            <input type="number" id="price" class="form-control" name="price" value="<?= $prod[0]['price_of_sale'] ?>">
          </div>
          <div class="mb-3">
            <label for="price" class="form-label">Alapegység</label>
            <input type="number" id="pricebase" class="form-control" name="pricebase" value="<?= $prod[0]['base_unit'] ?>">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <img src="<?= $prod[0]['image'] ?>" width="100" class="form-control">
            <input id="image" type="file" name="image" class="form-control" src="<?= $prod[0]['image'] ?>" data-picture_id="<?= $prod[0]['image'] ?>">
          </div>
